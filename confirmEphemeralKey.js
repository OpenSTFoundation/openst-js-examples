...
/**
 * @fileoverview Nodejs Program to Confirm Ephemeral Key in a given TokenHolder Contract. See confirm method for sample code.
...
program.on('--help', () => {
  ...
  console.log('  Example:');
  console.log('');
  console.log('    node confirmEphemeralKey.js -t 0xf8c9018DEA785A7cc8A59fE1F8A64B6f64f060cD -w 0x39e76d2c955462674cd2dab10dbf46135dd2af24 -i 2');
  console.log('');
  console.log('');
});
