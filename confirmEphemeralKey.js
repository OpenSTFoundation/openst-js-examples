...
/**
 * @fileoverview Nodejs Program to Confirm Ephemeral Key in a given TokenHolder Contract.
...
program.on('--help', () => {
  ...
  console.log('');
  console.log(
    '    node confirmEphemeralKey.js --token-holder 0xf8c9018DEA785A7cc8A59fE1F8A64B6f64f060cD --wallet 0x39e76d2c955462674cd2dab10dbf46135dd2af24 --transaction-id 2'
  );
  console.log('');
  console.log('');
});
